...
--  LEUART0
package Interfaces.EFM32.LEUART0 is
   pragma Preelaborate;
...
--  hardware.
   ...
   type CTRL_Register is record
      ...
      --  Parity-Bit Mode
      PARITY         : CTRL_PARITY_Field := Interfaces.EFM32.LEUART0.NONE;
      --  Stop-Bit Mode
      ...
      --  TX Delay Transmission
      TXDELAY        : CTRL_TXDELAY_Field := Interfaces.EFM32.LEUART0.NONE;
      --  unspecified
   ...
   type ROUTELOC0_Register is record
      --  I/O Location
      RXLOC          : ROUTELOC0_RXLOC_Field := Interfaces.EFM32.LEUART0.LOC0;
      --  unspecified
      Reserved_6_7   : Interfaces.EFM32.UInt2 := 16#0#;
      --  I/O Location
      TXLOC          : ROUTELOC0_TXLOC_Field := Interfaces.EFM32.LEUART0.LOC0;
      --  unspecified
   ...
   type INPUT_Register is record
      --  RX PRS Channel Select
      RXPRSSEL      : INPUT_RXPRSSEL_Field := Interfaces.EFM32.LEUART0.PRSCH0;
      --  unspecified
   ...
   --  LEUART0
   type LEUART0_Peripheral is record
      --  Control Register
   ...
   for LEUART0_Peripheral use record
   ...
   --  LEUART0
   LEUART0_Periph : aliased LEUART0_Peripheral
     with Import, Address => LEUART0_Base;

end Interfaces.EFM32.LEUART0;
