...
--  LETIMER0
package Interfaces.EFM32.LETIMER0 is
   pragma Preelaborate;
...
--  COMP1
   ...
   type CTRL_Register is record
      --  Repeat Mode
      REPMODE        : CTRL_REPMODE_Field := Interfaces.EFM32.LETIMER0.FREE;
      --  Underflow Output Action 0
      UFOA0          : CTRL_UFOA0_Field := Interfaces.EFM32.LETIMER0.NONE;
      --  Underflow Output Action 1
      UFOA1          : CTRL_UFOA1_Field := Interfaces.EFM32.LETIMER0.NONE;
      --  Output 0 Polarity
   ...
   type ROUTELOC0_Register is record
      ...
      OUT0LOC        : ROUTELOC0_OUT0LOC_Field :=
                        Interfaces.EFM32.LETIMER0.LOC0;
      --  unspecified
...
--  LETIMER
   ...
   type PRSSEL_Register is record
      ...
      PRSSTARTSEL    : PRSSEL_PRSSTARTSEL_Field :=
                        Interfaces.EFM32.LETIMER0.PRSCH0;
      --  unspecified
      ...
      PRSSTARTMODE   : PRSSEL_PRSSTARTMODE_Field :=
                        Interfaces.EFM32.LETIMER0.NONE;
      --  unspecified
   ...
   --  LETIMER0
   type LETIMER0_Peripheral is record
      --  Control Register
   ...
   for LETIMER0_Peripheral use record
   ...
   --  LETIMER0
   LETIMER0_Periph : aliased LETIMER0_Peripheral
     with Import, Address => LETIMER0_Base;

end Interfaces.EFM32.LETIMER0;
