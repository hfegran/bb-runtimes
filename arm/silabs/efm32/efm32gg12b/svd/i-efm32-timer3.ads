...
--  TIMER3
package Interfaces.EFM32.TIMER3 is
   pragma Preelaborate;
...
--  lower numbered neighbor Timer
   ...
   type CTRL_Register is record
      --  Timer Mode
      MODE           : CTRL_MODE_Field := Interfaces.EFM32.TIMER3.UP;
      --  unspecified
      ...
      --  Timer Rising Input Edge Action
      RISEA          : CTRL_RISEA_Field := Interfaces.EFM32.TIMER3.NONE;
      --  Timer Falling Input Edge Action
      FALLA          : CTRL_FALLA_Field := Interfaces.EFM32.TIMER3.NONE;
      --  unspecified
      ...
      CLKSEL         : CTRL_CLKSEL_Field :=
                        Interfaces.EFM32.TIMER3.PRESCHFPERCLK;
      --  unspecified
      Reserved_18_23 : Interfaces.EFM32.UInt6 := 16#0#;
      --  Prescaler Setting
      PRESC          : CTRL_PRESC_Field := Interfaces.EFM32.TIMER3.DIV1;
      --  Always Track Inputs
   ...
   type LOCK_Register is record
      ...
      TIMERLOCKKEY   : LOCK_TIMERLOCKKEY_Field :=
                        Interfaces.EFM32.TIMER3.UNLOCKED;
      --  unspecified
   ...
   type ROUTELOC0_Register is record
      --  I/O Location
      CC0LOC         : ROUTELOC0_CC0LOC_Field := Interfaces.EFM32.TIMER3.LOC0;
      --  unspecified
      Reserved_6_7   : Interfaces.EFM32.UInt2 := 16#0#;
      --  I/O Location
      CC1LOC         : ROUTELOC0_CC1LOC_Field := Interfaces.EFM32.TIMER3.LOC0;
      --  unspecified
      Reserved_14_15 : Interfaces.EFM32.UInt2 := 16#0#;
      --  I/O Location
      CC2LOC         : ROUTELOC0_CC2LOC_Field := Interfaces.EFM32.TIMER3.LOC0;
      --  unspecified
      Reserved_22_23 : Interfaces.EFM32.UInt2 := 16#0#;
      --  I/O Location
      CC3LOC         : ROUTELOC0_CC3LOC_Field := Interfaces.EFM32.TIMER3.LOC0;
      --  unspecified
      Reserved_30_31 : Interfaces.EFM32.UInt2 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
...
--  BOTH)
   ...
   type CC0_CTRL_Register is record
      --  CC Channel Mode
      MODE           : CC0_CTRL_MODE_Field := Interfaces.EFM32.TIMER3.OFF;
      --  Output Invert
      ...
      --  Compare Match Output Action
      CMOA           : CC0_CTRL_CMOA_Field := Interfaces.EFM32.TIMER3.NONE;
      --  Counter Overflow Output Action
      COFOA          : CC0_CTRL_COFOA_Field := Interfaces.EFM32.TIMER3.NONE;
      --  Counter Underflow Output Action
      CUFOA          : CC0_CTRL_CUFOA_Field := Interfaces.EFM32.TIMER3.NONE;
      --  unspecified
      Reserved_14_15 : Interfaces.EFM32.UInt2 := 16#0#;
      --  Compare/Capture Channel PRS Input Channel Selection
      PRSSEL         : CC0_CTRL_PRSSEL_Field :=
                        Interfaces.EFM32.TIMER3.PRSCH0;
      --  unspecified
      Reserved_20_23 : Interfaces.EFM32.UInt4 := 16#0#;
      --  Input Capture Edge Select
      ICEDGE         : CC0_CTRL_ICEDGE_Field :=
                        Interfaces.EFM32.TIMER3.RISING;
      --  Input Capture Event Control
      ICEVCTRL       : CC0_CTRL_ICEVCTRL_Field :=
                        Interfaces.EFM32.TIMER3.EVERYEDGE;
      --  PRS Configuration
...
--  BOTH)
   ...
   type CC1_CTRL_Register is record
      --  CC Channel Mode
      MODE           : CC1_CTRL_MODE_Field := Interfaces.EFM32.TIMER3.OFF;
      --  Output Invert
      ...
      Reserved_5_7   : Interfaces.EFM32.UInt3 := 16#0#;
      --  Compare Match Output Action
      CMOA           : CC1_CTRL_CMOA_Field := Interfaces.EFM32.TIMER3.NONE;
      --  Counter Overflow Output Action
      COFOA          : CC1_CTRL_COFOA_Field := Interfaces.EFM32.TIMER3.NONE;
      --  Counter Underflow Output Action
      CUFOA          : CC1_CTRL_CUFOA_Field := Interfaces.EFM32.TIMER3.NONE;
      --  unspecified
      Reserved_14_15 : Interfaces.EFM32.UInt2 := 16#0#;
      --  Compare/Capture Channel PRS Input Channel Selection
...
--  BOTH)
   ...
   type CC2_CTRL_Register is record
      --  CC Channel Mode
      MODE           : CC2_CTRL_MODE_Field := Interfaces.EFM32.TIMER3.OFF;
      --  Output Invert
      ...
      Reserved_5_7   : Interfaces.EFM32.UInt3 := 16#0#;
      --  Compare Match Output Action
      CMOA           : CC2_CTRL_CMOA_Field := Interfaces.EFM32.TIMER3.NONE;
      --  Counter Overflow Output Action
      COFOA          : CC2_CTRL_COFOA_Field := Interfaces.EFM32.TIMER3.NONE;
      --  Counter Underflow Output Action
      CUFOA          : CC2_CTRL_CUFOA_Field := Interfaces.EFM32.TIMER3.NONE;
      --  unspecified
      Reserved_14_15 : Interfaces.EFM32.UInt2 := 16#0#;
      --  Compare/Capture Channel PRS Input Channel Selection
...
--  BOTH)
   ...
   type CC3_CTRL_Register is record
      --  CC Channel Mode
      MODE           : CC3_CTRL_MODE_Field := Interfaces.EFM32.TIMER3.OFF;
      --  Output Invert
      ...
      Reserved_5_7   : Interfaces.EFM32.UInt3 := 16#0#;
      --  Compare Match Output Action
      CMOA           : CC3_CTRL_CMOA_Field := Interfaces.EFM32.TIMER3.NONE;
      --  Counter Overflow Output Action
      COFOA          : CC3_CTRL_COFOA_Field := Interfaces.EFM32.TIMER3.NONE;
      --  Counter Underflow Output Action
      CUFOA          : CC3_CTRL_CUFOA_Field := Interfaces.EFM32.TIMER3.NONE;
      --  unspecified
      Reserved_14_15 : Interfaces.EFM32.UInt2 := 16#0#;
      --  Compare/Capture Channel PRS Input Channel Selection
   ...
   type DTTIME_Register is record
      --  DTI Prescaler Setting
      DTPRESC        : DTTIME_DTPRESC_Field := Interfaces.EFM32.TIMER3.DIV1;
      --  unspecified
      Reserved_4_7   : Interfaces.EFM32.UInt4 := 16#0#;
      --  DTI Rise-time
   ...
   type DTFC_Register is record
      ...
      --  DTI Fault Action
      DTFA           : DTFC_DTFA_Field := Interfaces.EFM32.TIMER3.NONE;
      --  unspecified
      Reserved_18_23 : Interfaces.EFM32.UInt6 := 16#0#;
   ...
   --  TIMER3
   type TIMER3_Peripheral is record
      --  Control Register
   ...
   for TIMER3_Peripheral use record
   ...
   --  TIMER3
   TIMER3_Periph : aliased TIMER3_Peripheral
     with Import, Address => TIMER3_Base;

end Interfaces.EFM32.TIMER3;
