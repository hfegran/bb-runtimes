...
--  CAN1
package Interfaces.EFM32.CAN1 is
   pragma Preelaborate;
...
--  CPU wrote this value to the LEC.
   ...
   type STATUS_Register is record
      --  Last Error Code
      LEC           : STATUS_LEC_Field := Interfaces.EFM32.CAN1.NONE;
   ...
   type TEST_Register is record
      ...
      --  Control of CAN_TX Pin
      TX            : TEST_TX_Field := Interfaces.EFM32.CAN1.CORE;
   ...
   type ROUTE_Register is record
      ...
      --  RX Pin Location
      RXLOC          : ROUTE_RXLOC_Field := Interfaces.EFM32.CAN1.LOC0;
      --  TX Pin Location
      TXLOC          : ROUTE_TXLOC_Field := Interfaces.EFM32.CAN1.LOC0;
      --  unspecified
