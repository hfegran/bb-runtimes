...
--  ACMP0
package Interfaces.EFM32.ACMP0 is
   pragma Preelaborate;
   ...
   type CTRL_Register is record
      ...
      --  Power Select
      PWRSEL          : CTRL_PWRSEL_Field := Interfaces.EFM32.ACMP0.AVDD;
      --  ACMP Accuracy Mode
      ACCURACY        : CTRL_ACCURACY_Field := 16#0#;
      --  unspecified
      Reserved_16_17  : Interfaces.EFM32.UInt2 := 16#0#;
      --  Input Range
      INPUTRANGE      : CTRL_INPUTRANGE_Field := Interfaces.EFM32.ACMP0.FULL;
   ...
   type INPUTSEL_Register is record
      ...
      --  VA Selection
      VASEL          : INPUTSEL_VASEL_Field := Interfaces.EFM32.ACMP0.VDD;
      --  VB Selection
      ...
      --  Capacitive Sense Mode Internal Resistor Select
      CSRESSEL       : INPUTSEL_CSRESSEL_Field := Interfaces.EFM32.ACMP0.RES0;
      --  unspecified
   ...
   type HYSTERESIS_Register is record
      --  Hysteresis Select When ACMPOUT=0
      HYST           : HYSTERESIS0_HYST_Field := Interfaces.EFM32.ACMP0.HYST0;
      --  unspecified
   ...
   type ROUTELOC0_Register is record
      --  I/O Location
      OUTLOC        : ROUTELOC0_OUTLOC_Field := Interfaces.EFM32.ACMP0.LOC0;
      --  unspecified
   ...
   type EXTIFCTRL_Register is record
      ...
      APORTSEL      : EXTIFCTRL_APORTSEL_Field :=
                       Interfaces.EFM32.ACMP0.APORT0X;
      --  unspecified
   ...
   --  ACMP0
   type ACMP0_Peripheral is record
      --  Control Register
   ...
   for ACMP0_Peripheral use record
   ...
   --  ACMP0
   ACMP0_Periph : aliased ACMP0_Peripheral
     with Import, Address => ACMP0_Base;

end Interfaces.EFM32.ACMP0;
