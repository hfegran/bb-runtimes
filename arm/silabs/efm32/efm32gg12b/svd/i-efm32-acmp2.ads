...
--  ACMP2
package Interfaces.EFM32.ACMP2 is
   pragma Preelaborate;
   ...
   type CTRL_Register is record
      ...
      --  Power Select
      PWRSEL          : CTRL_PWRSEL_Field := Interfaces.EFM32.ACMP2.AVDD;
      --  ACMP Accuracy Mode
      ACCURACY        : CTRL_ACCURACY_Field := 16#0#;
      --  unspecified
      Reserved_16_17  : Interfaces.EFM32.UInt2 := 16#0#;
      --  Input Range
      INPUTRANGE      : CTRL_INPUTRANGE_Field := Interfaces.EFM32.ACMP2.FULL;
   ...
   type INPUTSEL_Register is record
      ...
      --  VA Selection
      VASEL          : INPUTSEL_VASEL_Field := Interfaces.EFM32.ACMP2.VDD;
      --  VB Selection
      ...
      --  Capacitive Sense Mode Internal Resistor Select
      CSRESSEL       : INPUTSEL_CSRESSEL_Field := Interfaces.EFM32.ACMP2.RES0;
      --  unspecified
   ...
   type HYSTERESIS_Register is record
      --  Hysteresis Select When ACMPOUT=0
      HYST           : HYSTERESIS0_HYST_Field := Interfaces.EFM32.ACMP2.HYST0;
      --  unspecified
   ...
   type ROUTELOC0_Register is record
      --  I/O Location
      OUTLOC        : ROUTELOC0_OUTLOC_Field := Interfaces.EFM32.ACMP2.LOC0;
      --  unspecified
   ...
   type EXTIFCTRL_Register is record
      ...
      APORTSEL      : EXTIFCTRL_APORTSEL_Field :=
                       Interfaces.EFM32.ACMP2.APORT0X;
      --  unspecified
   ...
   --  ACMP2
   type ACMP2_Peripheral is record
      --  Control Register
   ...
   for ACMP2_Peripheral use record
   ...
   --  ACMP2
   ACMP2_Periph : aliased ACMP2_Peripheral
     with Import, Address => ACMP2_Base;

end Interfaces.EFM32.ACMP2;
