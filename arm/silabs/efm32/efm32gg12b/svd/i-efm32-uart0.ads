...
--  UART0
package Interfaces.EFM32.UART0 is
   pragma Preelaborate;
   ...
   type CTRL_Register is record
      ...
      --  Oversampling
      OVS            : CTRL_OVS_Field := Interfaces.EFM32.UART0.X16;
      --  unspecified
...
--  stop-bit only
   ...
   type FRAME_Register is record
      --  Data-Bit Mode
      DATABITS       : FRAME_DATABITS_Field := Interfaces.EFM32.UART0.EIGHT;
      --  unspecified
      Reserved_4_7   : Interfaces.EFM32.UInt4 := 16#0#;
      --  Parity-Bit Mode
      PARITY         : FRAME_PARITY_Field := Interfaces.EFM32.UART0.NONE;
      --  unspecified
      Reserved_10_11 : Interfaces.EFM32.UInt2 := 16#0#;
      --  Stop-Bit Mode
      STOPBITS       : FRAME_STOPBITS_Field := Interfaces.EFM32.UART0.ONE;
      --  unspecified
   ...
   type TRIGCTRL_Register is record
      ...
      --  Trigger PRS Channel Select
      TSEL           : TRIGCTRL_TSEL_Field := Interfaces.EFM32.UART0.PRSCH0;
      --  unspecified
   ...
   type IRCTRL_Register is record
      ...
      --  IrDA TX Pulse Width
      IRPW           : IRCTRL_IRPW_Field := Interfaces.EFM32.UART0.ONE;
      --  IrDA RX Filter
      ...
      --  IrDA PRS Channel Select
      IRPRSSEL       : IRCTRL_IRPRSSEL_Field := Interfaces.EFM32.UART0.PRSCH0;
      --  unspecified
      Reserved_12_31 : Interfaces.EFM32.UInt20 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type INPUT_Register is record
      --  RX PRS Channel Select
      RXPRSSEL       : INPUT_RXPRSSEL_Field := Interfaces.EFM32.UART0.PRSCH0;
      --  unspecified
      Reserved_4_6   : Interfaces.EFM32.UInt3 := 16#0#;
      --  PRS RX Enable
      RXPRS          : INPUT_RXPRS_Field := 16#0#;
      --  CLK PRS Channel Select
      CLKPRSSEL      : INPUT_CLKPRSSEL_Field := Interfaces.EFM32.UART0.PRSCH0;
      --  unspecified
   ...
   type I2SCTRL_Register is record
      ...
      --  I2S Word Format
      FORMAT         : I2SCTRL_FORMAT_Field := Interfaces.EFM32.UART0.W32D32;
      --  unspecified
   ...
   type TIMING_Register is record
      ...
      --  TX Frame Start Delay
      TXDELAY        : TIMING_TXDELAY_Field := Interfaces.EFM32.UART0.DISABLE;
      --  unspecified
      Reserved_19_19 : Interfaces.EFM32.Bit := 16#0#;
      --  Chip Select Setup
      CSSETUP        : TIMING_CSSETUP_Field := Interfaces.EFM32.UART0.ZERO;
      --  unspecified
      Reserved_23_23 : Interfaces.EFM32.Bit := 16#0#;
      --  Inter-character Spacing
      ICS            : TIMING_ICS_Field := Interfaces.EFM32.UART0.ZERO;
      --  unspecified
      Reserved_27_27 : Interfaces.EFM32.Bit := 16#0#;
      --  Chip Select Hold
      CSHOLD         : TIMING_CSHOLD_Field := Interfaces.EFM32.UART0.ZERO;
      --  unspecified
...
--  TCMP0 event
   ...
   type TIMECMP_Register is record
      ...
      TSTART         : TIMECMP0_TSTART_Field :=
                        Interfaces.EFM32.UART0.DISABLE;
      --  unspecified
      Reserved_19_19 : Interfaces.EFM32.Bit := 16#0#;
      --  Source Used to Disable Comparator 0
      TSTOP          : TIMECMP0_TSTOP_Field := Interfaces.EFM32.UART0.TCMP0;
      --  unspecified
      Reserved_23_23 : Interfaces.EFM32.Bit := 16#0#;
   ...
   type ROUTELOC0_Register is record
      --  I/O Location
      RXLOC          : ROUTELOC0_RXLOC_Field := Interfaces.EFM32.UART0.LOC0;
      --  unspecified
      Reserved_6_7   : Interfaces.EFM32.UInt2 := 16#0#;
      --  I/O Location
      TXLOC          : ROUTELOC0_TXLOC_Field := Interfaces.EFM32.UART0.LOC0;
      --  unspecified
      Reserved_14_15 : Interfaces.EFM32.UInt2 := 16#0#;
      --  I/O Location
      CSLOC          : ROUTELOC0_CSLOC_Field := Interfaces.EFM32.UART0.LOC0;
      --  unspecified
      Reserved_22_23 : Interfaces.EFM32.UInt2 := 16#0#;
      --  I/O Location
      CLKLOC         : ROUTELOC0_CLKLOC_Field := Interfaces.EFM32.UART0.LOC0;
      --  unspecified
   ...
   type ROUTELOC1_Register is record
      --  I/O Location
      CTSLOC         : ROUTELOC1_CTSLOC_Field := Interfaces.EFM32.UART0.LOC0;
      --  unspecified
      Reserved_6_7   : Interfaces.EFM32.UInt2 := 16#0#;
      --  I/O Location
      RTSLOC         : ROUTELOC1_RTSLOC_Field := Interfaces.EFM32.UART0.LOC0;
      --  unspecified
      Reserved_14_31 : Interfaces.EFM32.UInt18 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
