...
--  ADC0
package Interfaces.EFM32.ADC0 is
   pragma Preelaborate;
...
--  channel closed if WARMUPMODE is not NORMAL
   ...
   type CTRL_Register is record
      ...
      --  Prescalar Setting for ADC Sample and Conversion Clock
      PRESC            : CTRL_PRESC_Field := Interfaces.EFM32.ADC0.NODIVISION;
      --  unspecified
      ...
      --  Oversample Rate Select
      OVSRSEL          : CTRL_OVSRSEL_Field := Interfaces.EFM32.ADC0.X2;
      ...
      CHCONREFWARMIDLE : CTRL_CHCONREFWARMIDLE_Field :=
                          Interfaces.EFM32.ADC0.PREFSCAN;
   end record
   ...
   type SINGLECTRL_Register is record
      ...
      RES            : SINGLECTRL_RES_Field :=
                        Interfaces.EFM32.ADC0.Val_12BIT;
      --  Single Channel Reference Selection
      REF            : SINGLECTRL_REF_Field := Interfaces.EFM32.ADC0.Val_1V25;
      ...
      AT_k           : SINGLECTRL_AT_Field :=
                        Interfaces.EFM32.ADC0.Val_1CYCLE;
      --  unspecified
...
--  attenuation factor)
   ...
   type SCANCTRL_Register is record
      ...
      --  Scan Sequence Resolution Select
      RES            : SCANCTRL_RES_Field := Interfaces.EFM32.ADC0.Val_12BIT;
      --  Scan Sequence Reference Selection
      REF            : SCANCTRL_REF_Field := Interfaces.EFM32.ADC0.Val_1V25;
      --  unspecified
      Reserved_8_23  : Interfaces.EFM32.UInt16 := 16#0#;
      --  Scan Acquisition Time
      AT_k           : SCANCTRL_AT_Field := Interfaces.EFM32.ADC0.Val_1CYCLE;
      --  unspecified
      Reserved_28_28 : Interfaces.EFM32.Bit := 16#0#;
...
--  attenuation factor)
   ...
   type SCANINPUTSEL_Register is record
      ...
      INPUT0TO7SEL   : SCANINPUTSEL_INPUT0TO7SEL_Field :=
                        Interfaces.EFM32.ADC0.APORT0CH0TO7;
      --  unspecified
