...
--  PCNT0
package Interfaces.EFM32.PCNT0 is
   pragma Preelaborate;
...
--  greater than, or equal to PCNT_TOP[7:0].
   ...
   type CTRL_Register is record
      --  Mode Select
      MODE           : CTRL_MODE_Field := Interfaces.EFM32.PCNT0.DISABLE;
      ...
      --  Controls When the Counter Counts
      CNTEV          : CTRL_CNTEV_Field := Interfaces.EFM32.PCNT0.BOTH;
      --  Controls When the Auxiliary Counter Counts
      AUXCNTEV       : CTRL_AUXCNTEV_Field := Interfaces.EFM32.PCNT0.NONE;
      --  Non-Quadrature Mode Counter Direction Control
      CNTDIR         : CTRL_CNTDIR_Field := 16#0#;
      --  Edge Select
      EDGE           : CTRL_EDGE_Field := 16#0#;
      --  Sets the Mode for Triggered Compare and Clear
      TCCMODE        : CTRL_TCCMODE_Field := Interfaces.EFM32.PCNT0.DISABLED;
      --  unspecified
      Reserved_18_18 : Interfaces.EFM32.Bit := 16#0#;
      --  Set the LFA Prescaler for Triggered Compare and Clear
      TCCPRESC       : CTRL_TCCPRESC_Field := Interfaces.EFM32.PCNT0.DIV1;
      --  unspecified
      Reserved_21_21 : Interfaces.EFM32.Bit := 16#0#;
      --  Triggered Compare and Clear Compare Mode
      TCCCOMP        : CTRL_TCCCOMP_Field := Interfaces.EFM32.PCNT0.LTOE;
      --  PRS Gate Enable
      PRSGATEEN      : CTRL_PRSGATEEN_Field := 16#0#;
      --  TCC PRS Polarity Select
      TCCPRSPOL      : CTRL_TCCPRSPOL_Field := 16#0#;
      --  TCC PRS Channel Select
      TCCPRSSEL      : CTRL_TCCPRSSEL_Field := Interfaces.EFM32.PCNT0.PRSCH0;
      --  unspecified
   ...
   type ROUTELOC0_Register is record
      --  I/O Location
      S0INLOC        : ROUTELOC0_S0INLOC_Field := Interfaces.EFM32.PCNT0.LOC0;
      --  unspecified
      Reserved_6_7   : Interfaces.EFM32.UInt2 := 16#0#;
      --  I/O Location
      S1INLOC        : ROUTELOC0_S1INLOC_Field := Interfaces.EFM32.PCNT0.LOC0;
      --  unspecified
   ...
   type INPUT_Register is record
      --  S0IN PRS Channel Select
      S0PRSSEL       : INPUT_S0PRSSEL_Field := Interfaces.EFM32.PCNT0.PRSCH0;
      --  unspecified
      Reserved_4_4   : Interfaces.EFM32.Bit := 16#0#;
      --  S0IN PRS Enable
      S0PRSEN        : INPUT_S0PRSEN_Field := 16#0#;
      --  S1IN PRS Channel Select
      S1PRSSEL       : INPUT_S1PRSSEL_Field := Interfaces.EFM32.PCNT0.PRSCH0;
      --  unspecified
   ...
   --  PCNT0
   type PCNT0_Peripheral is record
      --  Control Register
   ...
   for PCNT0_Peripheral use record
   ...
   --  PCNT0
   PCNT0_Periph : aliased PCNT0_Peripheral
     with Import, Address => PCNT0_Base;

end Interfaces.EFM32.PCNT0;
