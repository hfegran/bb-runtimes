...
--  I2C1
package Interfaces.EFM32.I2C1 is
   pragma Preelaborate;
...
--  this results in a 1280us timeout.
   ...
   type CTRL_Register is record
      ...
      --  Clock Low High Ratio
      CLHR           : CTRL_CLHR_Field := Interfaces.EFM32.I2C1.STANDARD;
      --  unspecified
      Reserved_10_11 : Interfaces.EFM32.UInt2 := 16#0#;
      --  Bus Idle Timeout
      BITO           : CTRL_BITO_Field := Interfaces.EFM32.I2C1.OFF;
      --  unspecified
      Reserved_14_14 : Interfaces.EFM32.Bit := 16#0#;
      --  Go Idle on Bus Idle Timeout
      GIBITO         : CTRL_GIBITO_Field := 16#0#;
      --  Clock Low Timeout
      CLTO           : CTRL_CLTO_Field := Interfaces.EFM32.I2C1.OFF;
      --  unspecified
   ...
   type ROUTELOC0_Register is record
      --  I/O Location
      SDALOC         : ROUTELOC0_SDALOC_Field := Interfaces.EFM32.I2C1.LOC0;
      --  unspecified
      Reserved_6_7   : Interfaces.EFM32.UInt2 := 16#0#;
      --  I/O Location
      SCLLOC         : ROUTELOC0_SCLLOC_Field := Interfaces.EFM32.I2C1.LOC0;
      --  unspecified
